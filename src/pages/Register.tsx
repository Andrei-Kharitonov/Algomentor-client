      ...
      <div className="flex flex-col justify-between text-center max-w-[450px] m-auto">
        <form onSubmit={handleRegister}>
          <input
            ...
            required
            placeholder="EMAIL"
            className="border-[#5F3AA8] border-[2px] w-[450px] h-[70px] rounded-[30px] pl-[18px] mt-[40px] focus:outline-none"
          />
          ...
          <input
            ...
            className="border-[#5F3AA8] border-[2px] w-[450px] h-[70px] rounded-[30px] pl-[18px] mt-[30px] focus:outline-none"
          />
          ...
          <div className="flex justify-between items-center mt-[20px] pl-2 pr-2">
            <div className="flex items-center">
              <input
                ...
                id="horns"
                name="horns"
                className="border-[3px] border-[#5F3AA8]"
          ...
          <button className={styles.buttonLogin + ' w-[450px] rounded-[30px] h-[70px] text-white mt-[20px]'}>
            SIGNUP
          </button>
          ...
          <div className="flex justify-center mt-[20px]">
            <div className="inline-block p-[3px] rounded-[40px] bg-gradient-to-l from-[#e50f0f] to-[#fa3df4] outline-none ml-[15px]">
              <div
                ...
                className="w-[120px] h-[61px] bg-[#D4C4FF] rounded-[40px] flex justify-center m-auto items-center cursor-pointer"
              >
